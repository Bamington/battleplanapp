                       ...
                       {version.ver_notes && (
                         <div className="bg-bg-secondary rounded-lg p-3 mb-4">
                           <ReactMarkdown 
                             ...
                             components={{
                               p: ({ children }) => <p className="mb-2 last:mb-0 text-sm text-text">{children}</p>,
                               h1: ({ children }) => <h1 className="text-base font-bold mb-2 text-text">{children}</h1>,
                               h2: ({ children }) => <h2 className="text-sm font-bold mb-2 text-text">{children}</h2>,
                               h3: ({ children }) => <h3 className="text-xs font-bold mb-1 text-text">{children}</h3>,
